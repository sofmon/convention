...
func (o *Locale) IsValid() (valid bool) {
	if o == nil {
		return false
	}
	_, valid = locales[string(*o)]
	return
}

// Value in order to be used by sql driver
func (o Locale) Value() (driver.Value, error) {
	return string(o), nil
}

// Scan in order to be used for sql driver
func (o *Locale) Scan(value interface{}) error {
	...
	if err != nil {
		return fmt.Errorf("failed to scan value due to error: %w", err)
	}
...
func (o Localized) Copy() Localized {
	if o == nil {
		return nil
	}
	res := make(Localized, len(o))
	for k, v := range o {
		res[k] = v
	}
	return res
...
// Scan in order to be used for sql driver
func (o *Localized) Scan(value interface{}) error {
